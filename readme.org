...
writeChartSvg "other/banner.svg" $ gradient (Just (horig/360.0)) 100 6 100 (c0 & lch' % lLCH' .~ 0.2 ) (c1 & lch' % lLCH' .~ 0.3 ) & #charts %~ (<> named "text" [(TextChart (defaultTextStyle & #color .~ light & #size .~ 0.1) [("chart-svg", Point 0.4 0.25)])])
#+end_src
